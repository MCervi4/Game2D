...
void Menu::init(ShaderProgram& shaderProgram) {
	//spritesheet.loadFromFile("images/image1.jpg", TEXTURE_PIXEL_FORMAT_RGBA);
	//background = Sprite::createSprite(glm::ivec2(640, 480), glm::vec2(1.0f, 1.0f), &spritesheet, &shaderProgram);
	...
	spritesheet2.loadFromFile("images/image2.jpg", TEXTURE_PIXEL_FORMAT_RGBA);
	...
	spritesheet3.loadFromFile("images/image3.jpg", TEXTURE_PIXEL_FORMAT_RGBA);
